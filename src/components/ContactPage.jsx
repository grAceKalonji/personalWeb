    ...
    >
      <div className="max-w-2xl w-full">
        ...
        <p
          ...
          "
        >
          I've always wanted to do somethig really impactful So im open to discussing new projects and creative ideas.
        </p>
        ...
        <div className="space-y-8">
          ...
          >
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 bg-apple-gray-200 rounded-xl flex items-center justify-center group-hover:bg-apple-gray-300 transition-colors">
                <svg
          ...
          {/* LinkedIn */}
          <a
            href="https://www.linkedin.com/in/grace-kalonji-3965982b9/"
            target="_blank"
            rel="noopener noreferrer"
            className="
              block
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-sm font-medium text-apple-gray-500 mb-1">LinkedIn</h3>
                <p className="text-lg font-medium text-apple-gray-900">Grace Kalonji</p>
              </div>
            </div>
          </a>
        </div>
